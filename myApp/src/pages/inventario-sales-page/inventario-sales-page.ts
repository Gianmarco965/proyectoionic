...
/**
 * Generated class for the InventarioSalesPage page.
 *
...
@Component({
  selector: 'page-inventario-sales-page',
  templateUrl: 'inventario-sales-page.html',
})
export class InventarioSalesPage {
...
leerCategoria()
  {
   this.seleccionado="products";
      this.servicio.getCategoriasxStock()
      .subscribe(
        rs=>this.lista=rs,
        er=>console.log(er),
...
onClick(item)
{
  ...
  this.navCtrl.push(CatalogoSalesPage,{
...
share(item)
{
 ...
 gotoAdd()
  {
      this.navCtrl.push(AgregarCategoriaSalesPage);
...
archive(item:Inventario)
{
 var feedback = document.createElement('a');
    feedback.setAttribute('href', "http://localhost:8000/files/"+item.ficha_tecnica);
    feedback.click();
